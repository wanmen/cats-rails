Cats::Application.configure do
  ...
  config.assets.precompile += %w( markdown.js ie.js raty.js bootstrap-ie7.css bootstrap.css wm-default.css wm-pagedown.css search.js rails.js jquery.placeholder.js)
